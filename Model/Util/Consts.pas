...
resourcestring
  ...
  SPrinterIndexError = 'Nº de impressora fora da faixa';
  SInvalidPrinter = 'A impressora selecionada é inválida';
  ...
  SMsgDlgHelp = 'Aj&uda';
  SMsgDlgHelpNone = 'Não há ajuda disponível';
